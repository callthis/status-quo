...
While the above example is shown with a tiny sample of text, this step can be done on a larger corpus such as a list of regular English words from *Step 2,* in order to obtain *Diagram 2.*  
