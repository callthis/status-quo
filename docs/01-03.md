...
- We can parse the given corpus using a tokenizer, to obtain a list of its linguistic primitives, as shown in the following Python Notebook. This example also shows how to obtain a frequency count of the words in the given text.
